...
namespace CoreBlog.Controllers
{
    ...
    public class BlogController : Controller
    {
        ...
        {
            var values = bm.GetBlogListWithCate();
            return View(values);
        }
        ...
        public IActionResult BlogListByWriter()
        {
            ...
            var values = bm.GetBlogCategoryByWriter(writerIDAuth);
            return View(values);
        }
        [HttpGet]
        ...
        public IActionResult BlogUpdate(Blog p)
        {
            ...
            p.WriterID = writerIDAuth;
            p.BlogStatus = true;
            p.BlogCreateDate = bm.TGetByID(p.BlogID).BlogCreateDate;
            bm.TUpdate(p);
            return RedirectToAction("BlogListByWriter","Blog");
        }
